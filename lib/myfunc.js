...
msg.quotedMsg.fromMe = msg.quotedMsg.sender === lox.user.id.split(':')[0]+'@s.whatsapp.net' ? true : false
...
if (msg.key.fromMe){
msg.sender = lox.user.id.split(':')[0]+'@s.whatsapp.net'
}
